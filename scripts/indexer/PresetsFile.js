...
class PresetsFile {
  ...
  _processMetapropertyLine(line) {
    ...
    if (
      !isProperty &&
      lowCaseLine.startsWith(this._settings.OptionsDirectives.OPTION_DIRECTIVE)
    ) {
  ...
  _getOptionGroup(line) {
    const directiveRemoved = line
      .slice(
        this._settings.OptionsDirectives.BEGIN_OPTION_GROUP_DIRECTIVE.length
      )
      .trim();
  ...
  _getOption(line) {
    const directiveRemoved = line
      .slice(this._settings.OptionsDirectives.BEGIN_OPTION_DIRECTIVE.length)
      .trim();
  ...
  _isOptionChecked(lowCaseLine) {
    ...
    if (
      lowCaseLine.includes(this._settings.OptionsDirectives.OPTION_UNCHECKED)
    ) {
